...
export default function FriendProfile(props) {
    ...
    return (
        <div className="px-5 border-2 min-w-full h-screen overflow-y-auto">
            ...
            {expanded && <form action={createChat} className="flex flex-col">
                ...
                <input name="user" id="user" defaultValue={props.currentUser} className="hidden"/>
                <input name="friend" id="friend" defaultValue={props.friendName} className="hidden"/>
